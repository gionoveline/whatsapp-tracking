-- Fixes:
-- 1) RLS recursion on partner_members select policy (42P17)
-- 2) Ambiguous "id" in onboarding RPC (42702) by preferring column names.
...
begin
  ...
  for i in 0..99 loop
    ...
    begin
      ...
      returning public.partners.id into v_partner_id;
